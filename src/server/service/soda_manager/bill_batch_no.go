...
func (self *BillBatchNoService) Baisc(billIds ...interface{}) (*[]*mngModel.BillBatchNo, error) {
	list := &[]*mngModel.BillBatchNo{}
...
func (self *BillBatchNoService) BatchCreate(list *[]*mngModel.BillBatchNo) (int, error) {
	var err error
	var rows int64
	rows = int64(0)
...
func (self *BillBatchNoService) Delete(billIds ...interface{}) (int, error) {
	r := common.SodaMngDB_WR.Where("bill_id in (?)", billIds...).Delete(&mngModel.BillBatchNo{})
	if r.Error != nil {
		return 0, r.Error
	}
